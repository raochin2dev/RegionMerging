...
imgOrig = mpimg.imread(os.path.dirname(os.path.realpath(__file__))+'/MixedVegetables.jpg')
...
path = os.path.dirname(os.path.realpath(__file__))+"/res.jpg"
misc.imsave(path, newImage[::2,::2])
